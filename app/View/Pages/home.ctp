...
<head>
  ...
  <!-- Bootstrap core CSS -->
    <!--link href="C:\wamp64\www\cakephp\app\Plugin\Bootstrap4\css\bootstrap.min.css" rel="stylesheet">
      <link href="C:\wamp64\www\cakephp\app\Plugin\Bootstrap4\css\bootstrap.css" rel="stylesheet"-->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <!--graphique enlevé parce qu'inutile-->
    ...
    <!--script>window.jQuery || document.write('<script src="C:\\wamp64\\www\\cakephp\\app\\Plugin\\Bootstrap4\\js\\vendor\\jquery-slim.min.js"><\/script>')</script>
    <script src="C:\wamp64\www\cakephp\app\Plugin\Bootstrap4\js\vendor\popper.min.js"></script>
    <script src="C:\wamp64\www\cakephp\app\Plugin\Bootstrap4\js\bootstrap.min.js"></script-->
      <script>window.jQuery || document.write('<script src="../../Plugin/Bootstrap4/js/vendor/jquery-slim.min.js"><\/script>')</script>
      <script src="../../Plugin/Bootstrap4/js/vendor/popper.min.js"></script>
